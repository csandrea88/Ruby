...
class Array
  ...
  def where(hash = {})
    ...
    select do |m_item| 
      # iterates over the entire fixture array of hashes and select
      # statement will return an array with every array item that evaluates to true below.
      
      hash.all? do |key, value| 
        #iterates over all the key and value pairs sent from testing, without creating
        #or changing arrays
...
class TestWhere < Minitest::Test
  ...
  def setup
    ...
    @wolf    = {:name => 'The Wolf', :quote => 'I think fast, I talk fast and I need you guys to act fast if you wanna get out of this', :c => 'Pulp Fiction', :rank => 4}
